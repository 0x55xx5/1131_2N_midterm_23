          ...
          <section class='menu'>
            ...
            <div class='section-center'>
              <article class='menu-item'>
                <img src='./item-1.jpeg' alt='eggs' class='photo' />
                <div class='item-info'>
                  <header>
                    <h4>eggs</h4>
              ...
              <article class='menu-item'>
                <img src='./item-2.jpeg' alt='big' salad='' class='photo' />
                <div class='item-info'>
                  <header>
                    <h4>big salad</h4>
                    <h4 class='price'>12.59</h4>
              ...
              <article class='menu-item'>
                <img src='./item-3.jpeg' alt='fried' dish='' class='photo' />
                <div class='item-info'>
                  <header>
                    <h4>fried dish</h4>
                    <h4 class='price'>12.59</h4>
              ...
              <article class='menu-item'>
                <img src='./item-5.jpeg' alt='dinner' double='' class='photo' />
                <div class='item-info'>
                  <header>
                    <h4>dinner double</h4>
